...
import GetTransparent from './get-transparent';

class LazyLoadImg {
  private options: any;
  private _getTransparent: any;
  private _timer: any;
  // 构造函数 初始化参数
  ...
  loadImg (el: { dataset: { LazyLoadImgState: string; src: string; }; src: string; width: any; height: any; style: any; }) { // 加载图片
    var { options } = this;
